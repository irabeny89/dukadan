...
const SIGNUP_CUSTOMER_API_PATH = "/api/customers/signup";
const SIGNUP_OWNER_API_PATH = "/api/owners/signup";
const SIGNUP_ADMIN_API_PATH = "/api/admins/signup";
const SIGNUP_DRIVER_API_PATH = "/api/drivers/signup";
...
const createAuthRequest = (auth, role) => {
  const pathMap =
    auth === "signup"
      ? {
          admin: SIGNUP_ADMIN_API_PATH,
          customer: SIGNUP_CUSTOMER_API_PATH,
          driver: SIGNUP_DRIVER_API_PATH,
          owner: SIGNUP_OWNER_API_PATH,
        }
      : {
...
const auth = {
  ...
  loginOwner: createAuthRequest("login", "owner"),
  loginAdmin: createAuthRequest("login", "admin"),
  loginDriver: createAuthRequest("login", "driver"),
  loginCustomer: createAuthRequest("login", "customer"),
  signupOwner: createAuthRequest("signup", "owner"),
  signupAdmin: createAuthRequest("signup", "admin"),
  signupDriver: createAuthRequest("signup", "driver"),
  signupCustomer: createAuthRequest("signup", "customer"),
};
